...
CGame::CGame(int iClientH, char *cGameServerName, char *cGameServerIP, char *cGameServerLan, int iGameServerPort, char *cWorldName, int iTotalMaps)
{
	...
	memcpy(m_cGameAddressLan, cGameServerLan, 15);
